...
class WashingScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      shirtsCount: 0,
      ...
      formalPantsCount: 0,
      sherwaniCount: 0,
      largeBedsheetsCount: 0,
      mediumBedsheetsCount: 0,
      smallBedsheetsCount: 0,
  ...
  _storeData = async () => {
    const items={
      ...
      sherwani: this.state.sherwaniCount,
      largeBedsheets: this.state.largeBedsheetsCount,
      mediumBedsheets: this.state.mediumBedsheetsCount,
      smallBedsheets: this.state.smallBedsheetsCount,
    }
    try {
      await AsyncStorage.setItem("Washing",JSON.stringify(items));
    } catch (error) {
      // Error saving data
        ...
        <View>
          ...
          >
            ...
            <View style={styles.categoryBox}>
              ...
              <View style={styles.counterBox}>
                <TouchableOpacity onPress={() => this.decrement('largeBedsheetsCount')}>
                  <Text p muted>
                    {" "}
                    -{" "}
                  </Text>
                ...
                <Text p muted>
                  {"   "}
                  {this.state.largeBedsheetsCount}
                  {"   "}
                </Text>
                <TouchableOpacity onPress={() => this.increment('largeBedsheetsCount')}>
                  <Text p muted>
                    {" "}
                    +{" "}
                  </Text>
            ...
            <View style={styles.categoryBox}>
              ...
              <View style={styles.counterBox}>
                <TouchableOpacity onPress={() => this.decrement('mediumBedsheetsCount')}>
                  <Text p muted>
                    {" "}
                    -{" "}
                  </Text>
                ...
                <Text p muted>
                  {"   "}
                  {this.state.mediumBedsheetsCount}
                  {"   "}
                </Text>
                <TouchableOpacity onPress={() => this.increment('mediumBedsheetsCount')}>
                  <Text p muted>
                    {" "}
                    +{" "}
                  </Text>
            ...
            <View style={styles.categoryBox}>
              ...
              <View style={styles.counterBox}>
                <TouchableOpacity onPress={() => this.decrement('smallBedsheetsCount')}>
                  <Text p muted>
                    {" "}
                    -{" "}
                  </Text>
                ...
                <Text p muted>
                  {"   "}
                  {this.state.smallBedsheetsCount}
                  {"   "}
                </Text>
                <TouchableOpacity onPress={() => this.increment('smallBedsheetsCount')}>
                  <Text p muted>
                    {" "}
                    +{" "}
                  </Text>
